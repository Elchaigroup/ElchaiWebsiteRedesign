...
export const interns = {
  ...
  meet: {
    ...
    profiles: [
      { name: 'Abhishek Aju',   role: 'Growth & Marketing',      photo: '/elchai/interns/team/Abisheik-1.jpeg' },
      { name: 'Sanjula Hewage', role: 'QA Tester',               photo: '/elchai/interns/team/Sanjula.jpeg' },
      { name: 'Hajara',         role: 'AI Automation & Research', photo: '/elchai/interns/team/Hajra-1.jpeg' },
      { name: 'Tamara',         role: 'AI Automation & Research', photo: '/elchai/interns/team/Tamara.jpeg' },
      { name: 'Rubin',          role: 'AI Automation & Research', photo: '/elchai/interns/team/Rubin-1.jpeg' },
      { name: 'Sara',           role: 'AI Automation & Research', photo: '/elchai/interns/team/Sara.jpeg' },
      { name: 'Naseeha',        role: 'AI Automation & Research', photo: '/elchai/interns/team/Naseeha.jpeg' },
      { name: 'Shazin',         role: 'AI Automation & Research', photo: '/elchai/interns/team/Shahzin.jpeg' },
    ],
  ...
  life: {
    ...
    photos: [
      { alt: 'Team meeting',       src: '/elchai/interns/activities/Team.jpg' },
      { alt: 'Office work',        src: '/elchai/interns/activities/Brainstorm-session.jpg' },
      { alt: 'Brainstorm session', src: '/elchai/interns/activities/Mentor-session.jpeg' },
      { alt: 'Working at desk',    src: '/elchai/interns/activities/Working-at-desk.jpeg' },
      { alt: 'Workshop day',       src: '/elchai/interns/activities/Workshop-day.jpeg' },
      { alt: 'Collab work',        src: '/elchai/interns/activities/Collab-work.jpeg' },
      { alt: 'Office event',       src: '/elchai/interns/activities/IMG_4495-scaled.jpg' },
      { alt: 'Speaker event',      src: '/elchai/interns/activities/IMG_4378-scaled.jpg' },
    ],
  },
  internLife: {
    eyebrow: 'Intern Life',
